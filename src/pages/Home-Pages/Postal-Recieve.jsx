...
const PostalRecieve = () => {
    return (
        ...
        <div className="m-2">
            ...
            <div className="d-flex justify-content-between px-4">
                <h6 className="text-secondary fs-5">Postal Receive</h6>
            ...
            <div className="mx-4">
                <div className="row">
                    <div className="col col-3 shadow-lg py-4 rounded-2">
                        <div className="">
                            <p className="fs-5">Add Postal Recieve</p>
                        </div>
                        {/* Input fields  */}
                        <div className="Input-fields">
                            <label htmlFor="inputEmail4" className="form-label ms-1 text-secondary">Form Title<span className="text-danger">*</span></label>
                        ...
                        <div className="Input-fields mt-4">
                            <label htmlFor="inputEmail4" className="form-label ms-1 text-secondary fs-6">To Title</label>
                        ...
                        <div className="d-flex justify-content-center me-4 mt-4">
                            <button type="button" className="btn btn-primary visitor-button"><FaCheck /> Save Postal Receive</button>
                        </div>
                        {/* Input fields end  */}
                    </div>
    ...
    <table className="visitor-table visitor-table-hover visitor-table-fixed table-hover table-fixed w-100 mt-3">
        ...
        <tbody className="visitor-table-data">
            <tr>
                <td className="Admin-Query-Table-Data"><FaPlusCircle className="visitor-purple-icon" /> Technical Inquiry</td>
            ...
            <tr>
                ...
                <td className="Admin-Query-Table-Data">Customer asked general questions about the company return policy and warranties.</td>
            </tr>
            <tr>
